...
namespace ts {
     ...
     */
    export function isStaticInitializedProperty(member: ClassElement): member is PropertyDeclaration {
     ...
     * @param member The class element node.
     */
    export function isInstanceInitializedProperty(member: ClassElement): member is PropertyDeclaration {
     ...
     */
    export function isInitializedProperty(member: ClassElement, isStatic: boolean) {
